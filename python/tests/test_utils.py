...
class ParsingTest(unittest.TestCase):
    def test_hex_to_base64_standard(self):
        ...
        b64_string = "3q2+7xI0"
        self.assertEqual(bytes_to_base64(read_hex(hex_string)), b64_string)
    ...
    def test_hex_to_base64_padding(self):
        ...
        hex_string2 = "c0de"
        b64_string2 = "wN4="
        self.assertEqual(bytes_to_base64(read_hex(hex_string2)), b64_string2)

    def test_hex_to_base64_null(self):
        # Test null strings
        self.assertEqual(bytes_to_base64(read_hex("")), "")
